...
{
	UAbilityInfo* AbilityInfo = UAuraAbilityFunctionLibrary::GetAbilityInfo(GetAvatarActor());
	...
	FString& OutNextLevelDescription)
{
	...
	const UAbilityInfo* AbilityInfo = UAuraAbilityFunctionLibrary::GetAbilityInfo(GetAvatarActor());
