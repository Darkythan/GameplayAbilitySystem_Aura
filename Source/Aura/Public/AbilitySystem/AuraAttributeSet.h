...
public:
	...
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, IncomeDamage);
...
private:
	...
	void ShowFloatingText(const FEffectProperties& EffectProperties, float Damage, bool bBlocked, bool bCriticalHit) const;
};
